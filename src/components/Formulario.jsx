...
const Formulario = () => {
  return (
    <div className="md:w-1/2 lg:w-2/5">
      <h2 className="font-black text-3xl text-center up">Seguimiento Pacientes</h2>
      ...
      <form className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
        <div className="mb-5">
          ...
          <input id="mascota" type="text" placeholder="Nombrer de la mascota " className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md" />
        </div>
